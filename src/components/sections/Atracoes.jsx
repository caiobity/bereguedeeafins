        ...
        {ATTRACTIONS.length === 0 && (
          <div className="mx-auto max-w-xl rounded-3xl border-2 border-dashed border-purple/30 bg-white px-8 py-12 text-center shadow-sm">
            ...
            <p className="text-gray-600 text-pretty">
              Estamos finalizando o line-up. Siga{" "}
              <a
              ...
              no Instagram para ser o primeiro a saber.
            </p>
          </div>
        )}
          ...
          {ATTRACTIONS.map((attraction, i) => (
            ...
            >
              ...
              <div className="p-6 text-center">
                ...
                {attraction.role && (
                  <p className="mt-1 text-xs font-semibold uppercase tracking-wider text-pink">
                    {attraction.role}
                  </p>
                )}
                ...
                {attraction.instagrams?.length > 0 && (
                  <div className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5">
                    {attraction.instagrams.map((handle) => (
                      <a
                        key={handle}
                        href={`https://instagram.com/${handle}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-xs font-semibold text-purple/70 transition-colors hover:text-pink"
                      >
